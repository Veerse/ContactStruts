...
<body>
	...
	<div class="uk-flex uk-flex-center">
    	<div class="uk-card uk-card-default uk-card-body">
			...
			<html:form action="/EditGroup" styleClass="uk-form-stacked">
				<html:errors />
					<html:hidden property="groupID" styleId="groupID"></html:hidden> <!-- INPUT HERE -->
					
					<div class="uk-margin">
					 	<label class="uk-form-label" for="form-stacked-text">Group name</label>
		        		<div class="uk-form-controls">
							<html:text styleClass="uk-input" property="groupName"/> <!-- INPUT HERE -->
						</div>
					</div>
